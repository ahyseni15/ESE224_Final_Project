...
Copy::Copy(string ISBNIn, int idIn, string borrowedByIn, string reserverIn, int availableDateIn, int borrowDateIn, int expirationDateIn, vector<string> reserversIn)
{
	ISBN = ISBNIn;
	id = idIn;
	//book = bookIn;
